        ...
        <nav className="flex items-center justify-between flex-wrap bg-black-500 p-6">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div className="text-sm lg:flex-grow">
                    <Link href="/Home">
                        <p className="block mt-4 lg:inline-block lg:mt-0 text-white-200 hover:text-white mr-4">
                            Home
                        </p>
                    </Link>
                    <Link href="/AllBooks">
                    ...
                    <Link href="/SearchedBooks">
                        <p className="block mt-4 lg:inline-block lg:mt-0 text-white-200 hover:text-white">
                            Search Books
                        </p>
                    </Link>
                </div>
